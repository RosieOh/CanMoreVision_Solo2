                ...
                <div class="sub01_pt_wrap">
                    <div class="sub01_pt pt_lt">
                        <div class="sub01_pt_txt_in">
                            <h3>
                                Give daily pleasure through EDU<br/> <strong>정보화된 4차산업혁명에 부합한 교육의
                                <span>첫걸음</span>
                                <br>
                                <br>

                            </strong>
                                <strong>그 길을 CanMoreVision과 함께 하겠습니다!</strong>
                            </h3>
                            <div class="sub01_dia">
                                <div></div>
                                <div></div>
        ...
        <div class="sub_con">
            ...
            <div class="sub02_pt_wrap">
                <div class="sub02_pt pt01">
                    ...
                    <h4>혁신</h4>
                    <p>
                        혁신적이고 <span>4차 산업혁명에 부합한</span><br>교육 환경을 제공
                    </p>
                </div>
                <br>
                <br>
        ...
        <div class="sub_con">
            ...
            <div class="sub03_pt_up">
                ...
                <div class="sub03_pt_rt">
                    <div class="sub03_txt">
                        <h3>CanMoreVision는</h3>
                        <p>혁신적인 CanMoreVision만의 교육 경험과 지속 가능한 교육을 통해 학생들에게 삶의 풍요로움을 더하는 교육 서비스를 제공합니다.</p>
                    </div>
                </div>
                <!--.sub03_pt_rt-->
            </div>
