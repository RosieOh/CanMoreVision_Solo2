    ...
    <div class="contents" id="contents">
        <div class="content_header">
            <div class="breadcrumb">
                <p><a href="<%=path5 %>">Home</a> &gt; <span> 입시 자료집 </span> </p>
                <h2 class="page_tit"> 입시 자료집 </h2>
            </div>
        </div>
        <section class="page" id="page1">
            <div class="page_wrap">
                <h2 class="page_tit"> 입시 자료집 글쓰기 </h2>
                <hr>
                <form action="<%=path5%>/board/applimentBoard/addApplimentBoardPro.jsp" method="post">
                    <table class="tb1">
                        <tbody>
                        <tr>
