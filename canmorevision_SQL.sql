...
------------------------------------------------------------------------
-- 입시자료 게시판(Applimentboard) 테이블 생성
CREATE TABLE applimentboard(
                      bno INT PRIMARY KEY AUTO_INCREMENT,
                      title VARCHAR(200) NOT NULL,
                      content VARCHAR(1000),
                      author VARCHAR(16),
...
-- 입시자료 게시판 더미글 추가 8건
INSERT INTO applimentboard(title, content, author)
VALUES ('자료1', '입시자료1 입니다', 'admin');
INSERT INTO applimentboard(title, content, author)
VALUES ('자료2', '입시자료2 입니다', 'admin');
INSERT INTO applimentboard(title, content, author)
VALUES ('자료3', '입시자료3 입니다', 'admin');
INSERT INTO applimentboard(title, content, author)
VALUES ('자료4', '입시자료4 입니다', 'admin');
INSERT INTO applimentboard(title, content, author)
VALUES ('자료5', '입시자료5 입니다', 'admin');
INSERT INTO applimentboard(title, content, author)
VALUES ('자료6', '입시자료6 입니다', 'admin');
INSERT INTO applimentboard(title, content, author)
VALUES ('자료7', '입시자료7 입니다', 'admin');
INSERT INTO applimentboard(title, content, author)
VALUES ('자료8', '입시자료8 입니다', 'admin');

COMMIT;

SELECT * FROM applimentboard;
...
------------------------------------------------------------------------------------------------------------------------------
-- 입시자료집 게시판 댓글 테이블 생성
create table applimentComment(
                               cno INT AUTO_INCREMENT PRIMARY KEY,
                               bno INT,
                               author VARCHAR(16),
                               resdate TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP(),
                               content VARCHAR(200),
                               FOREIGN KEY(bno) REFERENCES applimentboard(bno) ON DELETE CASCADE
);

-- 더미 데이터 추가
INSERT INTO applimentComment(bno, author, content)
VALUES(1, 'admin', '댓글 기능 더미데이터1');
INSERT INTO applimentComment(bno, author, content)
VALUES(1, 'admin', '댓글 기능 더미데이터2');
INSERT INTO applimentComment(bno, author, content)
