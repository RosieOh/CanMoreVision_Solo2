...
<style>
    .pic_lst { clear:both; width: 1280px; margin: 0px auto; padding-top: 50px; }
    .pic_lst li { width: 220px; height: 222px; padding :25px; margin-left:30px; float:left;
    ...
    .pic_lst li:nth-child(3) { background-color: #F7BE81; border-radius: 50px;}
    ...
    .pic_arrow { border : 2px solid #fff; border-radius: 50px; padding:10px;  margin: 0 auto;  }
    ...
    #pic_a3:hover { background-color:#ffffff; color:#F7BE81; transition: 0.7s; }
    #pic_a4:hover { background-color:#ffffff; color:#9DC3E6; transition: 0.7s; }
</style>
...
<section class="page" id="page1">
    <div class="page_wrap">
        <ul class="pic_lst">
            ...
            <li class="item4">
                <a href="<%=path5 %>/board/applimentBoard/ApplimentBoardList.jsp?target=입시">
                    <strong class="pic_tit">입시</strong>
                    <em class="pic_com">입시 메뉴로 이동합니다.</em>
                    <span class="pic_arrow" id="pic_a4">이동하기 →</span>
                </a>
            </li>
        </ul>
    </div>
